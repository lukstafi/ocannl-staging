...
- After touching training dynamics, `Train.*` plumbing, or the autotuner's fission path, run `@train` (or the affected members) before pushing — per-PR CI may not execute it
