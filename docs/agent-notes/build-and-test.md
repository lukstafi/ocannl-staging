...
- `dead_export_scan` (gh-ocannl-806) is a source-level ratchet over direct `.ml` modules without a
  ...
  `external` values plus the values generated by top-level `sexp_of`, `of_sexp`, `sexp`, `compare`,
  and `equal` derivings, then counts qualified references from other sources. `[%sexp_of: M.ty]`,
