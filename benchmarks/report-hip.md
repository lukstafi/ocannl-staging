...
on Windows: PyTorch via AMD's official ROCm 7.2.1 wheels (torch 2.9.1+rocm7.2.1; ROCm builds
alias HIP onto torch's "cuda" device, reported below as cuda(hip)), tinygrad 0.13 via its
OpenCL device (CL). Note the pytorch/cpu/eager
...
|---|---|---|---|---|---|---|---|---|---|
| pytorch | cuda(hip) | eager | 5.996 | 5.897 | 6.093 | 5.971 | 0.46 | PASS (6.7e-08) | 170,786 |
...
| pytorch | cuda(hip) | eager | 1.818 | 1.718 | 1.992 | 1.129 | 0.57 | PASS (2.1e-07) |
...
| pytorch | cuda(hip) | eager | 0.438 | 0.425 | 0.547 | 0.336 | 0.44 | PASS (2.0e-07) |
...
| framework | backend | variant | step p50 ms | p10 | p90 | queued ms | compile s | parity |
|---|---|---|---|---|---|---|---|---|
| pytorch | cuda(hip) | eager | 1.180 | 1.124 | 1.325 | 0.825 | 0.44 | PASS (2.1e-07) |
