(* gh-ocannl-806: a top-level helper in a module without an [.mli] is an exported value, even when
   ...
   counts every value because it re-exports the interface. Values generated by [sexp_of], [of_sexp],
   [sexp], [compare], and [equal] derivings are exports too; the matching expression extensions
   count as references to the same generated names. Other PPX-generated values and values brought
...
let exempt_zero_reference_exports =
  [
    ...
    "C_syntax.sexp_of_mma_rendering";
    "C_syntax.sexp_of_mma_summary";
    "C_syntax.sexp_of_peel_skip";
    "C_syntax.sexp_of_peel_summary";
    "C_syntax.sexp_of_tensorization";
    "C_syntax.sexp_of_volatility_site";
    "C_syntax.sexp_of_volatility_summary";
